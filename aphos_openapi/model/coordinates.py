...
class Coordinates(ModelNormal):
    ...
    validations = {
        ('right_asc',): {
            'regex': {
                'pattern': r'\d{2}:\d{2}:\d{2}([.]\d+)?|^$',  # noqa: E501
            },
        },
        ('declination',): {
            'regex': {
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            right_asc (str): Right ascension. [optional]  # noqa: E501
            declination (str): Declination. [optional]  # noqa: E501
            radius (float): Radius. [optional]  # noqa: E501
        """
